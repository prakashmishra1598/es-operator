...
import (
	...
	elasticsearchclusterv1alpha1 "github.com/prakashmishra1598/es-operator/pkg/apis/elasticsearchcluster/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &elasticsearchclusterv1alpha1.ElasticsearchCluster{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner ElasticsearchCluster
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &elasticsearchclusterv1alpha1.ElasticsearchCluster{},
	})
	if err != nil {
		return err
	}
...
// blank assignment to verify that ReconcileElasticsearchCluster implements reconcile.Reconciler
...
func (r *ReconcileElasticsearchCluster) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &elasticsearchclusterv1alpha1.ElasticsearchCluster{}
	...
	// Set ElasticsearchCluster instance as the owner and controller
...
func newPodForCR(cr *elasticsearchclusterv1alpha1.ElasticsearchCluster) *corev1.Pod {
